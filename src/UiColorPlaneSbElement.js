...
export default class UiColorPlaneSbElement extends HTMLElement {

    /* =========================
     * static
     * ========================= */

    static tagName = 'ui-color-plane-sb';
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                :host::part(bg){
                    ...
                    background: linear-gradient(to bottom, transparent 0%, black 100%), linear-gradient(to right, white 0%, hsl(var(--h,0), 100%, 50%) 100%);
